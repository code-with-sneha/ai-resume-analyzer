  ...
  return (
    <main className='!pt-0'>
        ...
        <div className='flex flex-row w-full max-lg:flex-col-reverse'>
            ...
            bg-[url("/images/bg-small.svg")] bg-cover h-[100vh] sticky top-0 items-center justify-center '>
                {imageUrl && resumeUrl && (
            ...
            <section className='feedback-section'>
                <h2 className='text-4xl !text-black font-bold items-center justify-center'>Resume Review</h2>
                {feedback ? (
